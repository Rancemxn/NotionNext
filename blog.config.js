...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '沂天苓', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'a.k.a PitRc47', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://gffsery.vercel.app', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Blog,collist', // 网站关键词 英文逗号隔开
